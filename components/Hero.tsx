...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(60%_60%_at_10%_10%,rgba(241,196,15,.12),transparent),radial-gradient(50%_50%_at_90%_10%,rgba(241,196,15,.08),transparent)] pointer-events-none" />
